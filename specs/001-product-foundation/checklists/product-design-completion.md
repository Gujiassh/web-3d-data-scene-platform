...
| 审计项                           | 状态 | 权威证据                        |
| -------------------------------- | ---- | ------------------------------- |
| Studio 和 Factory Demo 信息架构  | Pass | `product-design.md` 第 2、8 节  |
...
| 审计项                         | 状态 | 权威证据                                |
| ------------------------------ | ---- | --------------------------------------- |
| 工厂资产范围、坐标、命名和预算 | Pass | `docs/ssot/factory-asset-strategy.md`   |
...
| FR-006 | Product Design 5；SceneDocument Contract    | AC-001、AC-004、M2            |
| FR-007 | Product Design 5；Technical Design 8        | AC-004、AC-006、M2            |
| FR-008 | Data Adapter Contract                       | AC-005、AC-011、M2            |
| FR-009 | Product Design 4；Technical Design 4        | AC-004、AC-006、M2            |
| FR-010 | SceneDocument Contract；Technical Design 11 | AC-001、AC-010、M0/M1         |
| FR-011 | Viewer API Contract                         | AC-006、AC-007、AC-010、M0/M2 |
| FR-012 | Product Design 8；Factory Asset Strategy    | AC-008、M3                    |
| FR-013 | Technical Design 13；Product Design 7       | AC-002、AC-005、AC-011、M2/M3 |
...
- 在线演示、README 教程和开源发布属于 M4 交付，不属于产品设计产物。
