...
export function SceneLayoutPanel({ layout }: SceneLayoutPanelProps) {
  ...
  return (
    <div className="scene-layout-panel">
      ...
      <section className="layout-section layout-feedback" aria-labelledby="layout-feedback-title">
