    ...
    AuthoringScene: React.forwardRef(function MockAuthoringScene(
      ...
      const handle = React.useMemo<AuthoringSceneHandle>(
        () => ({
          ...
          getHotspotViewState: vi.fn((annotationId: string) => ({
            annotationId,
            availability: "unavailable" as const,
            unavailableReason: "annotation-not-found" as const,
            resolution: "unresolved" as const,
            unresolvedReason: null,
            markerVisible: false as const,
            screenAnchor: null,
          })),
          ...
          startHotspotPlacement: vi.fn(),
          startHotspotReposition: vi.fn(),
          updateHotspotReticle: vi.fn(),
          acceptHotspotReticle: vi.fn(() => false),
          cancelHotspotSession: vi.fn(),
          finishHotspotDraft: vi.fn(() => false),
          acknowledgeHotspotCancellation: vi.fn(() => false),
