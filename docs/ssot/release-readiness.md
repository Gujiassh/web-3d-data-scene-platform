...
Feature 009 owns the final Product, Contract, Runtime, UI, Performance, Assets and Open-source gates. Automated/controller
evidence is useful but cannot become external-user, real Safari or reference-Iris-Xe evidence by wording or waiver.

The local default experience is a 90 m2 smart-home reference project assembled from an explicit allowlist of validated
owner assets plus a CC0 presentation shell. The generated archive is local-validation only until an authorization record
covers the exact 38 owner GLB hashes. The content remains a template over SceneDocument 1.4 and existing data-binding
...
- Implementation commit: `a0222c8c9a05b2495303e7e37ea68624dcf39320`.
- `pnpm test`: 124 files / 787 tests; `pnpm test:e2e`: 62 passed / 3 exact WebKit Studio skips.
- Smart-home archive SHA-256: `56e2de585df7a910015b73b146090c4f5df1f50ddefea5b474be8724599bdd24`.
- Smart-home report SHA-256: `7891d694b15ef66ce805b917e3e3b8d614032ea28076dc234df22a1487fb0e6b`.
- Chromium E1 smart-home evidence SHA-256: `6c2a4e56dae364bcdf244820405d67edf0e2021c8c9d421ef665938e51db5187`.
- Canonical software performance report SHA-256: `5092e6948407ab26ad80a3621d478c8a8778cb99a8c7cc8c1c45902529694bb0`;
  renderer is SwiftShader and strict memory slope is blocked.
